...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "0k7FvcL2CXOzrxHoQPrczYTCrqSBcktEy-iEaE9H";//七牛云个人中心密钥管理的AK密钥
    private static final String SECRETKEY = "cUrNkZGK0ORmn-F5elj7UsQfrMpnm0-AG5pcCtYp";//七牛云个人中心密钥管理的SK密钥
    private static final String BUCKET = "ljzeze";//七牛云的个人仓库
    public static final String DOMAIN= "http://qmlnypqqd.hn-bkt.clouddn.com/";//对象存储里的空间管理文件管理中的外链域名 ：http://+ 外链域名+ /
